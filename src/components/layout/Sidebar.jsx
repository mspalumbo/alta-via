...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col fixed left-0 top-0 h-full w-56 bg-[#142538] z-40">
        {/* Logo area */}
      ...
      {/* Mobile Top Bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 h-14 bg-[#142538] z-40 flex items-center justify-between px-4">
      ...
      {mobileOpen && (
        <div className="md:hidden fixed top-14 left-0 right-0 bg-[#142538] z-40 border-t border-white/10">
